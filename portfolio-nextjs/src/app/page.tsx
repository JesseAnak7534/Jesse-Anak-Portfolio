...
import { Mail, Phone, MapPin, ExternalLink, ArrowRight, FileDown, Microscope } from 'lucide-react';
      ...
      <section className="min-h-[70vh] flex flex-col justify-center">
        ...
        >
          ...
          >
            ...
            <Link
              href="/phd-overview"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg font-medium hover:from-emerald-600 hover:to-teal-600 transition-all hover:scale-105 shadow-lg shadow-emerald-500/25"
            >
              <Microscope size={18} />
